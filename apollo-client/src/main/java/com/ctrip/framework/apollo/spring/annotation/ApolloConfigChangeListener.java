...
public @interface ApolloConfigChangeListener {
   ...
   * <br />
   * If neither of {@code interestedKeys} and {@code interestedPrefixes} is specified then the {@code listener} will be notified when any key is changed.
   */
   ...
   * <br />
   * If neither of {@code interestedKeys} and {@code interestedPrefixes} is specified then the {@code listener} will be notified when whatever key is changed.
   */
  String[] interestedPrefixes() default {};
}
